...
class AsianDetailCrawler(object):
    def __init__(self, matchId, companyId, hasType=3, scheduleId=None,
    ...
    def qt_mobile_url(self):
        return "{0}&scheid={1}&companyid={2}".format(scrawler_config.qt_zq_mobile_asianDetail_url,
                ...
                if len(jsonData) > 0 and (jsonData[0]['Score'] == '即' or jsonData[0]['Score'] == '早'):
                    ...
                    for item in jsonData:
                        ...
                        if (self.hasType == 1 and matchState == 0) \
                            ...
                            if self.hasType != 2 and matchState == 0:
                                detail = [homeOdds, goal, awayOdds,
                                          modifyTime, oddsType, isBet,
...
if __name__ == '__main__':
    asianCrawler = AsianDetailCrawler(199152, 8, 1, 1736607, matchState=-1)
    data1 = asianCrawler.qt_mobile_get()
    print(data1)
    # t = time.time()
    # print(int(t)*1000)
