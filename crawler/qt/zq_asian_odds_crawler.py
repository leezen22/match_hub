...
class AsianOddsCrawler(object):
    ...
    @property
    def qt_web_url(self):
        return "{0}?id={1}".format(scrawler_config.qt_zq_web_asianOdds_url, self.scheduleId)
...
#     asianCrawler = AsianOddsCrawler(199152, 1736607, -1)
# #     data = asianCrawler.qt_mobile_get()
